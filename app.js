...
$(function() {
    ...
    $("#exercise2Button").on('click', function() {
      $("#exercise2 p").parent('div').css('background', 'lightblue')
    });
    ...
    $("#exercise3Button").on('click', function() {
      $("#exercise3 p").parents('div').css('background', 'lightgray')
    });
    ...
    $("#exercise5Button").on('click', function() {
      $(this).next().children('p').css('border', '1px solid cyan')
    });
    ...
    $("#exercise6Button").on('click', function() {
      $(this).prev().prev('div').find('span').css('color', 'purple')
    });
})